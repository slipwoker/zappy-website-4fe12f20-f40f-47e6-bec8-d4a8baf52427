document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        function createErrorElement(input) {
            ...
            errorEl.style.cssText = 'color: #e74c3c; font-size: 0.85rem; margin-top: 4px; display: none;';
        ...
        function showError(input, message) {
            if (!errorMessages[input.name]) {
                errorMessages[input.name] = createErrorElement(input);
            }
            const errorEl = errorMessages[input.name];
        ...
        function validateField(input) {
            ...
            if (input.hasAttribute('required') && !value) {
                const label = input.getAttribute('data-label') || name || 'This field';
            ...
            if (input.getAttribute('data-type') === 'phone' && value) {
            ...
            if (isValid) {
                ...
                fetch(action, fetchOptions)
                    ...
                    .then(function() {
                        ...
                        successMsg.style.cssText = 'color: #27ae60; padding: 12px; margin-top: 16px; background: #eafaf1; border-radius: 4px;';
                    ...
                    .catch(function() {
                        ...
                        errorMsg.style.cssText = 'color: #e74c3c; padding: 12px; margin-top: 16px; background: #fdf2f2; border-radius: 4px;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '4fe12f20-f40f-47e6-bec8-d4a8baf52427',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '4fe12f20-f40f-47e6-bec8-d4a8baf52427';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '4fe12f20-f40f-47e6-bec8-d4a8baf52427';
